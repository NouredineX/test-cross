      ...
      <div className="container">
          ...
          <div className="footer-col" id="footer-col-contact">
            ...
            <ul style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
              ...
              <li style={{ marginBottom: '0.8rem' }}>
                ...
                <a href="mailto:contact@travellingthroughmorocco.com?subject=Inquiry%20-%20Travelling%20Through%20Morocco" style={{ color: 'inherit', textDecoration: 'none' }} id="footer-contact-email-link">
                  contact@travellingthroughmorocco.com
                </a>
              </li>
              <li style={{ marginBottom: '0.8rem' }}>
                <span style={{ color: 'var(--color-primary)', marginRight: '6px' }}>📞</span>
        ...
        <div className="footer-bottom">
          ...
          <div className="social-links" id="footer-socials">
            <a href="https://www.facebook.com/travellingthroughmorocco" target="_blank" rel="noopener noreferrer" aria-label="Facebook" id="social-fb">
            ...
            <a href="https://www.pinterest.com/travellingthroughmorocco/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" id="social-pin">
            ...
            <a href="https://www.tripadvisor.com/Profile/travellingthroughmorocco" target="_blank" rel="noopener noreferrer" aria-label="TripAdvisor" id="social-ta">
