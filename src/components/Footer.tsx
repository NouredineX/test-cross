    ...
    <footer className="footer" id="main-footer">
      <div className="container">
          ...
          <div className="footer-col" id="footer-col-about">
            <Link to="/" className="navbar-logo" style={{ marginBottom: '1.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.6rem' }} id="footer-logo">
              <svg width="34" height="34" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="logo-svg">
                <path d="M50 15C32 15 18 29 18 47V85H32V47C32 37 40 29 50 29C60 29 68 37 68 47V85H82V47C82 29 68 15 50 15Z" fill="url(#duneGradFooter)" />
                ...
                <defs>
                  <linearGradient id="duneGradFooter" x1="18" y1="50" x2="82" y2="50" gradientUnits="userSpaceOnUse">
          ...
          <div className="footer-col" id="footer-col-contact">
            ...
            <ul style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
              ...
              <li style={{ marginBottom: '0.8rem' }}>
                ...
                <a href="mailto:wetravelmoroccoteam@gmail.com?subject=Inquiry%20-%20We%20Travel%20Morocco" style={{ color: 'inherit', textDecoration: 'none' }} id="footer-contact-email-link">
                  wetravelmoroccoteam@gmail.com
                </a>
              </li>
              <li style={{ marginBottom: '0.8rem' }}>
                <span style={{ color: 'var(--color-primary)', marginRight: '6px' }}>📞</span>
        ...
        <div className="footer-bottom">
          <p>
            &copy; {currentYear} wetravelmorocco.com. {t('footer.rights')} |{' '}
          ...
          <div className="social-links" id="footer-socials">
            <a href="https://web.facebook.com/profile.php?id=61592368601281" target="_blank" rel="noopener noreferrer" aria-label="Facebook" id="social-fb">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            <a href="https://www.instagram.com/we_travelmorocco/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" id="social-ig">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
            </a>
            <a href="https://www.pinterest.com/wetravelmoroccoteam/_profile/" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" id="social-pin">
            ...
            <a href="https://www.tripadvisor.com/Profile/Curiosity50480549449" target="_blank" rel="noopener noreferrer" aria-label="TripAdvisor" id="social-ta">
